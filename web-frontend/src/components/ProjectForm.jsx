...
const ProjectForm = ({ onSubmit }) => {
  //the stateful project object is empty at the start i.e. no properties or methods
  const [project, setProject] = useState({ title: "", description: "" });
  
  //handleChange is called whenever an input field is typed into by a user
  //the 'e' parameter represents the event object that contains the target.name and target.value properties and other methods
